...
<body>
  <div class="modal fade" id="afc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="afc">ASESORÍA FISCAL Y CONTABLE</h5>
        ...
        <div class="modal-body">
          <form action="app/agendar1.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="time" >Hora para agendar su posible cita</label><br><br>
            ...
            <div class="mb-3 visually-hidden">
              <label for="materia"></label><br><br>
              <input type="materia" name="materia" value="Contabilidad" class="col-form-label">
            </div>
            <input type="text" name="materia" style="display:none;" value="Contable">
