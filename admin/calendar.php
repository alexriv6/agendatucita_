...
$sentenciaSQL = $pdo->prepare("SELECT * FROM posibles WHERE id_posible = $id_posible");
...
<body><br><br>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-2">
        <a class="btn btn-primary" type="button" href="index.php">Volver</a>
      </div>
      <div class="col-md-2">
        <a class="btn btn-primary" type="button" href="agendados.php">Ver listado de agendados</a>
      </div>
    </div>
  </div><br>
  <div class="container">
    <div class="col-md-10 offset-1">
      <h1>Selecciona el día para agendar cita</h1>
      <?php foreach ($resultado as $key) ?>
      <label for="">Fecha estimada: <?php echo $key['date'] ?> </label>
      ...
      <div class="modal-content"><br><br>
         ...
         <div class="card offset-1" style="width: 25rem;">
            <div class="card-header">
              Datos del solicitante seleccionado:
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item"><b>Nombre: </b><?php echo $key['nombre'] ?></li>
              <li class="list-group-item"><b>Motivo de la visita: </b><?php echo $key['motivo'] ?></li>
              <li class="list-group-item"><b>Hora: </b><?php echo $key['time'] ?></li>
              <li class="list-group-item"><b>Día: </b><?php echo $key['date'] ?></li>
              <li class="list-group-item"><b>teléfono: </b><?php echo $key['tel'] ?></li>
              <li class="list-group-item"><b>email: </b><?php echo $key['email'] ?></li>
              <li class="list-group-item"><b>Materia: </b><?php echo $key['materia'] ?></li>
            </ul>
          </div><br><br>
          ...
          <div class="container-fluid">
            <form action="" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Título">
              </div>
              <div class="mb-3 visually-hidden">
              ...
              <div class="mb-3 visually-hidden">
                ...
                <input class="form-control" name="estatus" id="estatus" value="2">2</input>
              </div>
              <div class="mb-3 visually-hidden">
                <label for="id_posible" class="form-label"></label>
                <input class="form-control" name="id_posible" id="id_posible" value="<?php echo $key['id_posible'];?>"></input>
              </div>
            </form>
          </div>
        </div> 
